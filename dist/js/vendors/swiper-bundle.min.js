...
!function (e, t) {
  ...
  var re = [function (e) {
    ...
    function o(e) {
      ...
      if (t.params.slidesPerView > 1 && !t.params.centeredSlides && (i = t.params.slidesPerView), t.params.thumbs.multipleActiveThumbs || (i = 1), i = Math.floor(i), s.slides.removeClass(r), s.params.loop || s.params.virtual && s.params.virtual.enabled) for (var _e73 = 0; _e73 < i; _e73 += 1) {
        s.$wrapperEl.children("[data-swiper-slide-index=\"".concat(t.realIndex + _e73, "\"]")).addClass(r);
      } else for (var _e74 = 0; _e74 < i; _e74 += 1) {
        s.slides.eq(t.realIndex + _e74).addClass(r);
      }
      ...
      if (t.realIndex !== s.realIndex || l) {
        ...
        if (s.params.loop) {
          ...
          var _e75 = s.slides.eq(_o6).prevAll("[data-swiper-slide-index=\"".concat(t.realIndex, "\"]")).eq(0).index(),
              _a29 = s.slides.eq(_o6).nextAll("[data-swiper-slide-index=\"".concat(t.realIndex, "\"]")).eq(0).index();

          _i18 = void 0 === _e75 ? _a29 : void 0 === _a29 ? _e75 : _a29 - _o6 == _o6 - _e75 ? s.params.slidesPerGroup > 1 ? _a29 : _o6 : _a29 - _o6 < _o6 - _e75 ? _a29 : _e75, _r11 = t.activeIndex > t.previousIndex ? "next" : "prev";
    ...
    s({
      ...
      setTranslate: function setTranslate() {
        ...
        for (var _a34 = 0; _a34 < e.length; _a34 += 1) {
          ...
          var _n9 = t.params.fadeEffect.crossFade ? Math.max(1 - Math.abs(_e80[0].progress), 0) : 1 + Math.min(Math.max(_e80[0].progress, -1), 0);
    ...
    s({
      ...
      setTranslate: function setTranslate() {
        ...
        for (var _e83 = 0, _t54 = a.length; _e83 < _t54; _e83 += 1) {
          var _t55 = a.eq(_e83),
              _s52 = i[_e83],
              _l8 = (o - _t55[0].swiperSlideOffset - _s52 / 2) / _s52,
